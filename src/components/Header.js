  ...
  return (
    <div className='mainheader'>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/blog :id">Blogs</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/editBlog/ :id">Add New</a>
        </li>
      </ul>
    ...
    <div class="d-flex align-items-center">
      ...
      <a class="text-reset me-3" href="https://ken-sarowiwa.github.io/KenafricaGram/">
